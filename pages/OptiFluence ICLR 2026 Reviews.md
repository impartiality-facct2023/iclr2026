## Responses
	...
	- Since our canaries fit the DP definition perfectly, "visual naturalness" is within our desiderata and thus we are unsure it is metric worth optimizing for. Afterall, the threat model is different from an attack using adversarial example so "bounding the (visual) perturbation" is not a requirement.
