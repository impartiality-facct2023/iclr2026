## Responses
	...
	- > Could the authors please add experiments on lower values of $\varepsilon$ (viz. 1 and <1)? While these values may yield lower utility of the model, theoretically they are desirable (especially <1) and it would be useful to see how Optifluence (and its baselines) perform in this regime.
		...
		- As we discuss in Response W2 to Reviewer VkF8's Q5, tight DP-Auditing often requires *canary gradients* or manipulation of the training procedure. Input-space canaries therefore are at an inherent disadvantage. Having said that, they enable third-party auditing, are architecture-agnostic, and transfer.
		-
	-
