## Responses
	...
	- > W2. Only report TPR @ Low FPR; other metrics such as AUC should also be considered.
		...
		- First, we note that we already share ROC curves in Figure 7 in Appendix C.3. We can easily add AUC numbers (area under these curves) to each. Would that alleviate
-
-
-
-
